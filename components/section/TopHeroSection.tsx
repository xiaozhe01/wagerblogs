...
export default function TopHeroSection() {
  return (
    <section className="flex flex-col gap-5">
      ...
      <p className="text-2xl font-medium leading-lead text-text-body max-w-[62ch] text-pretty">
      ...
      <ArrowLink
        href="/reviews"
        className="inline-flex gap-1 group items-center min-h-11 text-md text-text-primary font-semibold"
      >
        Compare top sites
      </ArrowLink>
    </section>
