  ...
  const rail = (
    <>
      ...
      <InfoCard
        ...
        titleClassName="font-bold text-sm text-text-primary mb-2.5"
        body="How we research, source, and correct our work."
        cta={
          <ArrowLink
            href="/about"
      ...
      <InfoCard
        title="Corrections"
        body="Spotted something wrong? We publish corrections rather than quietly editing."
        cta={
          <ArrowLink
            href="/contact"
            className="inline-flex items-center gap-1 text-md text-text-primary font-semibold group"
